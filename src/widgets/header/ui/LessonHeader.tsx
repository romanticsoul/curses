...
import { ToggleThemeButton } from '@/entities/toggle-theme'
import { MyEducationButton } from '@/entities/my-education-button'
  ...
  return (
    <header className="z-20 my-6 flex w-full flex-col gap-4 bg-transparent  px-12">
      <div className="flex h-full items-center justify-between  gap-12">
        ...
        <div className="hidden  flex-1 items-center md:flex md:justify-start">
